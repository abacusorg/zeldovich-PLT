...
#define YY_DECL                             \
    yy::phParser::token_type yylex(         \
       yy::phParser::semantic_type *yylval, \
...
public:
    ...
    void
    InstallSym(const char *name, void *ptr, int type, int dim, int stride, bool init);
    ...
    void stuffit(
       SYMENT **spec, VAL_STACK *list, int len, int varzone, const yy::location &l
    );
